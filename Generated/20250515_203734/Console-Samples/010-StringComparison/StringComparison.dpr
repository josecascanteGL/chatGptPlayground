...
begin
  try
    // Initialize variables with different string values and their lowercase/uppercase variants
    s1 := 'IciOuPas';
    s1L := s1.ToLower;
    ...
    // Output the original strings and their lowercase/uppercase variants
    writeln('s1');
    writeln(s1);
    writeln(s1L);
    writeln(s1LI);
    ...
    // Compare the strings and their variants
    writeln('s1 = s2');
    writeln(s1 = s2);
    writeln(s1L = s2L);
    writeln(s1U = s2U);
    ...
    // Compare using CompareStr and CompareText functions
    writeln('CompareStr');
