...
begin
  try
    // Initializing different string variables with variations of the same text
    s1 := 'IciOuPas';
    s1L := s1.ToLower; // Convert s1 to lowercase
    s1LI := s1.ToLowerInvariant; // Convert s1 to lowercase in invariat culture
    s1U := s1.ToUpper; // Convert s1 to uppercase
    s1UI := s1.ToUpperInvariant; // Convert s1 to uppercase in invariat culture
    ...
    // Display various forms of the strings s1, s2, and s3
    writeln('s1');
    writeln(s1);
    writeln(s1L);
    writeln(s1LI);
    ...
    // Comparing the strings and their variations
    writeln('s1 = s2');
    writeln(s1 = s2);
    writeln(s1L = s2L);
    writeln(s1U = s2U);
    ...
    // Performing comparison using CompareStr function
    writeln('CompareStr');
    ...
    // Performing comparison using CompareText function
    writeln('CompareText');
