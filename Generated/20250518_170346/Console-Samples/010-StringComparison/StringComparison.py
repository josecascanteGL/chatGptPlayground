...
s1LI = s1.lower()  # Lowercase invariant is equivalent to lower in Python as locale isn't affected
s1U = s1.upper()  # Convert to uppercase
s1UI = s1.upper()  # Uppercase invariant
...
print('CompareStr')
print((s1 > s2) - (s1 < s2))  # Compare strings lexicographically
...
print('CompareText')
# Case-insensitive comparison equivalent to Delphi's 'CompareText'
...
input()  # Wait for user to press Enter to close, replaces readln in Delphi