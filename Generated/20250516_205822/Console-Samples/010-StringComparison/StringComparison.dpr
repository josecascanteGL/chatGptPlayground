// The following code is a Delphi program that demonstrates string comparison functions.
...
begin
  try
    // Initializing and manipulating strings for comparison testing
    s1 := 'IciOuPas';
    s1L := s1.ToLower; // Convert to lowercase
    s1LI := s1.ToLowerInvariant; // Convert to lowercase with invariant culture
    s1U := s1.ToUpper; // Convert to uppercase
    s1UI := s1.ToUpperInvariant; // Convert to uppercase with invariant culture
    ...
    // Displaying string values for comparison
    writeln('s1');
    writeln(s1);
    writeln(s1L);
    writeln(s1LI);
    ...
    // Using CompareStr function for case-sensitive comparison
    writeln('CompareStr');
    ...
    // Using CompareText function for case-insensitive comparison
    writeln('CompareText');
    ...
    on E: Exception do
      // Handling exceptions and displaying error information
