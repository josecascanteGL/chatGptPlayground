...
s1LI = s1.casefold()  # Perform unicode case folding
s1U = s1.upper()  # Convert to uppercase
s1UI = s1.upper()  # Using upper as a stand-in for ToUpperInvariant
...
print('s1 = s2')
print(s1 == s2)  # Comparison is exact match
print(s1L == s2L)
print(s1U == s2U)
print(s1LI == s2LI)
print(s1UI == s2UI)
...
print('CompareText')
print((s1.lower() > s2.lower()) - (s1.lower() < s2.lower()))  # Case-insensitive comparison
