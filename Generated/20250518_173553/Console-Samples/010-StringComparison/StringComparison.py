...
s1LI = s1.casefold()  # More aggressive lowercase conversion, useful for some language-specific situations
s1U = s1.upper()  # Convert to uppercase
s1UI = s1.upper()  # In Python, upper() handles most cases invariantly
...
print('s1 = s2')
print(s1 == s2)  # Comparison operator == used instead of = in Delphi
print(s1L == s2L)
print(s1U == s2U)
print(s1LI == s2LI)
print(s1UI == s2UI)
...
print('CompareStr')
print((s1 > s2) - (s1 < s2))  # Python does not have a direct equivalent to compareStr; this evaluates to -1, 0, or 1
...
print('CompareText')
print((s1.lower() > s2.lower()) - (s1.lower() < s2.lower()))  # Comparing case-insensitively
...
input()  # Equivalent to readln in Delphi; waits for the user to hit enter before continuing